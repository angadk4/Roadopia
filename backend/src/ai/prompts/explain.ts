...
- text: 2-4 sentences, max 120 words, plain and concrete. Explain what the drive IS (which named roads, how long/far, what stops) and how it fits the "asked" facts (character, drive time, avoids, places) — when something asked was not delivered it appears in "relaxed"; say so plainly.
